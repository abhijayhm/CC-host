...
class HadoopStorage(Storage):
    ...
    def __init__(self, location=None, base_url=None, file_permissions_mode=None,
        ...
        self.hdfs = HadoopFileSystem(host=self.hadoop_host,port=self.hadoop_port)
    ...
    def _open(self, name, mode='rb'):
        return File(self.hdfs.open_input_file(self.path(name)))
    ...
    def _save(self, name, content):
        ...
        hdfs.open_append_stream(full_path).upload(content)
